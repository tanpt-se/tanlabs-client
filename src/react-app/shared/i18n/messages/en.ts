import type { PublicInfoPanelText, ShellBaseText } from '@tanlabs/types';
import { BRAND } from '@tanlabs/config';
import { shellChromeEn } from '@/shared/i18n/shell-base-en';
...
export const enClientLang = {
  ...
  dashboard: {
    ...
    chart: {
      title: 'Weekly sign-ins (sample)',
      description: 'Mock dashboard data rendered with D3.',
      ariaLabel: 'Bar chart of mock weekly sign-in counts',
    },
    charts: {
      weeklySignIns: {
        title: 'Weekly sign-ins (sample)',
        description: 'Mock sign-in volume by weekday.',
        ariaLabel: 'Bar chart of mock weekly sign-in counts',
      },
      activeSessions: {
        title: 'Active sessions (sample)',
        description: 'Mock monthly active session trend.',
        ariaLabel: 'Line chart of mock monthly active sessions',
      },
      successRate: {
        title: 'Auth success rate (sample)',
        description: 'Mock weekly authentication success percentage.',
        ariaLabel: 'Area chart of mock authentication success rate',
      },
      devices: {
        title: 'Devices (sample)',
        description: 'Mock sign-in device mix.',
        ariaLabel: 'Donut chart of mock device distribution',
      },
    },
  },
  myAccount: {
